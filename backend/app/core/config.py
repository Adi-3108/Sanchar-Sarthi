...
class Settings(BaseSettings):
    ...
    rag_llm_provider: str = Field(default="gemini", validation_alias="RAG_LLM_PROVIDER")
    rag_llm_api_key: str | None = Field(default=None, validation_alias="RAG_LLM_API_KEY")
    rag_llm_model: str | None = Field(default="gemini-2.0-flash", validation_alias="RAG_LLM_MODEL")
