  ...
  return (
    ...
    >
      <div className="flex flex-col gap-3 lg:flex-row lg:items-end lg:justify-between">
        <div>
          <p className="text-[11px] uppercase tracking-[0.24em] text-blue-600">Manpower Plan</p>
          <h2 className="mt-2 text-2xl font-semibold text-slate-900">Officer deployment posture</h2>
        </div>
        <p className="text-3xl font-semibold text-slate-900">{manpower.recommended_total_officers}</p>
      </div>
      ...
      <p className="mt-auto pt-5 text-sm leading-7 text-slate-600">{manpower.note}</p>
    </section>
  );
}
